...
use App\Model\HostMaster;
use App\Http\Resources\HostMasterResource;
use Illuminate\Http\Response;
use Illuminate\Support\Facades\DB;

class hostMasterController extends Controller
{
    ...
    {
        return HostMasterResource::collection(HostMaster::get());
    }
    ...
    {
        return  HostMaster::find($comentNum);
    }
    ...
    {
        return  HostMaster::find($request);
    }
    ...
    public function update(Request $request, DashBoardUser $dashBordUser)
    {
        ...
        HostMaster::where('id', $request->id)->update([
