...
use App\Model\WorkerMaster;
use App\Http\Resources\WorkerMasterResource;
use Illuminate\Http\Response;
use Illuminate\Support\Facades\DB;

class WorkerMasterController extends Controller
{
    ...
    {
        return WorkerMasterResource::collection(WorkerMaster::get());
    }
    ...
    {
        return  WorkerMaster::find($comentNum);
    }
    ...
    {
        return  WorkerMaster::find($request);
    }
     ...
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  \App\Model\LineMaster  $dashBordUser
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, WorkerMaster $dashBordUser)
    {
        
        DB::beginTransaction();
        //broadcast(new dashBordEvent($request->all()))->toOthers();
        LineMaster::where('id', $request->id)->update([
