...
use App\Model\LineMaster;
use App\Http\Resources\LineMasterResource;
...
class LineMasterController extends Controller
{
    ...
    {
        return LineMasterResource::collection(LineMaster::get());
    }
    ...
    {
        return  LineMaster::find($comentNum);
    }
    ...
    {
        return  LineMaster::find($request);
    }
