...
use App\Model\PartStruct;
use App\Http\Resources\PartStructResource;
use Illuminate\Http\Response;
use Illuminate\Support\Facades\DB;

class PartStructController extends Controller
{
    ...
    {
        return PartStructResource::collection(PartStruct::get());
    }
    ...
    {
        return  PartStruct::find($comentNum);
    }
    ...
    {
        return  PartStruct::find($request);
    }
    ...
    public function update(Request $request, DashBoardUser $dashBordUser)
    {
        ...
        PartStruct::where('id', $request->id)->update([
