    ...
    export default {
        ...
        data() {
            return {
                ...
                {text: '部門', align: 'center', value: 'orderCode'},
                {text: 'ラインID', align: 'center', value: 'lineCode'},
                {text: '割合',align: 'center',value: 'ratio'},
                {text: '優先フラグ',align: 'center',value: 'priorityFlag'},
        ...
        methods: {
          ...
          update(userProfile) {
              axios.patch(`/api/linemaster/${userProfile.id}`, userProfile)
              .then(res =>  console.log(res.data))
              .catch(error => console.log(error.res))
              this.getDashbordUser();
          },
          getDashbordUser() {
             axios.get('/api/linemaster')
          ...
          test() {
            ...
            axios.post('/api/linemaster/', test)
            .then(res => {
